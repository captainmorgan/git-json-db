...
$otest = new APIObjectTest($_REQUEST);
...
if(getenv('REQUEST_METHOD') == 'POST') { 
    ...
    $otest->setRequestBody($request_body);
    ...
    if (!$request_body) {
    	if (isset($_GET['payload'])) {
    		...
    		$otest->setRequestBody($_GET['payload']);
    	}
    }
}
...
if (isset($_REQUEST['method'])) {
	...
	switch ($_REQUEST['method']) {
        ...
        case 'getCustomerIdByEmail':
        	$object->getCustomerIdByEmail($_GET['payload'], 1);
        	break;
       case 'addDogWithEmail':
        	$object->addDogWithEmail();
        	break;
       case 'addDelegateWithEmail':
        	$otest->addDelegateWithEmail();
        	break;    
        case 'descSchema':
        	$object->descSchema();
        	break; 	
