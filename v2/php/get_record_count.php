...
//$sOrderClause = "`first_name`, `last_name`, `id`";
		...
		try {	
			...
			//$sql = $conn->prepare($sQuery);  // You have to change this line to use the new authentication
